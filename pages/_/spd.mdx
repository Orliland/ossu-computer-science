...
**Course Link:** [https://learning.edx.org/course/course-v1:UBCx+SPD1x+2T2015](https://learning.edx.org/course/course-v1:UBCx+SPD1x+2T2015)

Alternative Links:

- [https://www.edx.org/course/how-to-code-simple-data](https://www.edx.org/course/how-to-code-simple-data) (Up to Week 6A)
- [https://www.edx.org/course/how-to-code-complex-data](https://www.edx.org/course/how-to-code-complex-data) (Week 6B onwards)
...
- Some links to starter files in the course are no longer working. You can download the starter files from this github repository: [https://github.com/ossu/spd-starters](https://github.com/ossu/spd-starters). You can download a zip file of all the starter files using [this link](https://github.com/ossu/spd-starters/archive/refs/heads/main.zip).
...
- If you are stuck somewhere, feel free to ask questions. You can join the OSSU chat for this course here:
  - Chat for discussions up to Week 6A: [https://discord.gg/RfqAmGJ](https://discord.gg/RfqAmGJ)
  - Chat for discussions from Week 6B onwards: [https://discord.gg/kczJzpm](https://discord.gg/kczJzpm)
...
<img
  src="/change-dr-racket-notation.png"
  width="600"
  alt="The language choosing dialog of Dr. Racket"
/>
...
<img
  src="/automatic-parentheses.png"
  width="600"
  alt="Enable automatic closing of parentheses"
/>
