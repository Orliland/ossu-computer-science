...
- Match the curricular standards of the [CS 2013](/faq/curricular_guidelines): Curriculum Guidelines for Undergraduate Degree Programs in Computer Science
...
**[How to contribute](/faq/contributing)**

**[Getting help](/faq/help)** (Details about our FAQ and chatroom)
...
- You can also interact through GitHub issues. If there is a problem with a course, or a change needs to be made to the curriculum, this is the place to start the conversation. Read more [here](/faq/contributing).
...
>
> - An unmaintained and deprecated firebase app. Read more in the [FAQ](/faq#why-is-the-firebase-ossu-app-different-or-broken).
> - An unmaintained and deprecated trello board
> - Third-party notion templates

# Curriculum

**Curriculum version**: `8.0.0` (see [CHANGELOG](/faq/changelog))
...
- [Core CS](#core-cs) assumes the student has already taken [high school math](/faq#how-can-i-review-the-math-prerequisites), including algebra, geometry, and pre-calculus.
...
| :-------------------------------------------------- | :------: | :-----------: | :-----------: | :--------------------------------: |
| [Introduction to programming](/_/intro-programming) | 10 weeks | 10 hours/week |     none      | [chat](https://discord.gg/syA242Z) |
...
| Courses                                                                      | Duration |    Effort     |                            Prerequisites                             |             Discussion             |
| :--------------------------------------------------------------------------- | :------: | :-----------: | :------------------------------------------------------------------: | :--------------------------------: |
| [Introduction to Computer Science and Programming using Python](/_/intro-cs) | 9 weeks  | 15 hours/week | [high school algebra](https://www.khanacademy.org/math/algebra-home) | [chat](https://discord.gg/jvchSm9) |
...
| Courses                                                                                      | Duration |     Effort      |                                                           Prerequisites                                                            |                                    Discussion                                     |
| :------------------------------------------------------------------------------------------- | :------: | :-------------: | :--------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------: |
| [Systematic Program Design](/_/spd)                                                          | 13 weeks | 8-10 hours/week |                                                                none                                                                | chat: [part 1](https://discord.gg/RfqAmGJ) / [part 2](https://discord.gg/kczJzpm) |
...
| [Operating Systems: Three Easy Pieces](/_/ostep)                                                                                                                    | 10-12 weeks | 6-10 hours/week  |                                  -                                   |                                                                        Nand to Tetris Part II                                                                         | [chat](https://discord.gg/wZNgpep) |
...
| Courses                                                                                                                                      | Duration |     Effort      |                                        Prerequisites                                        |             Discussion             |
| :------------------------------------------------------------------------------------------------------------------------------------------- | :------: | :-------------: | :-----------------------------------------------------------------------------------------: | :--------------------------------: |
| [Essence of Linear Algebra](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab)                                        |    -     |        -        |              [high school math](/faq#how-can-i-review-the-math-prerequisites)               | [chat](https://discord.gg/m6wHbP6) |
